...
const en = {
  ...
  products: {
    ...
    basics: 'Basics',
    pricing: 'Pricing & tax',
    packagingSection: 'Packs',
    baseUnit: 'Base unit',
    baseUnitHint: 'What you count stock in — BOTTLE, EA, KG.',
    descriptionLabel: 'Description',
    sellingPrice: 'Selling price',
    costPrice: 'Cost price',
    costPriceHint: 'What you pay. Needed to report margin.',
    taxClassLabel: 'Tax',
    taxStandard: 'Standard',
    taxZero: 'Zero-rated',
    taxExempt: 'Exempt',
    returnableLabel: 'Deposit per {unit}',
    returnableHint: 'Leave empty if the unit is not returned.',
    addPack: 'Add a pack',
    packUnit: 'Unit',
    packQuantity: 'Holds',
    ...
    packCost: 'Pack cost',
    packBarcode: 'Barcode',
    packHint: 'A crate of 24 sells as one unit and deducts 24 from stock.',
    removePack: 'Remove pack',
    close: 'Close',
    editTitle: 'Edit product',
    editLabel: 'Edit {name}',
    saveChanges: 'Save changes',
    baseUnitLocked: 'Cannot change: stock is counted in this unit.',
    rowActions: 'Actions',
    archive: 'Take out of sale',
    archiveLabel: 'Take {name} out of sale',
    restore: 'Put back on sale',
    restoreLabel: 'Put {name} back on sale',
    packagingInvalid: 'Each pack needs a unit, how many it holds, and a price.',
    quartersOn: 'Quarters allowed',
    quartersOff: 'No quarters',
    perPack: '{unit} of {count}',
...
const rw: Dictionary = {
  ...
  products: {
    ...
    adding: 'Birimo kongerwaho…',
    basics: 'Ibyibanze',
    pricing: 'Ibiciro n’umusoro',
    packagingSection: 'Amapaki',
    baseUnit: 'Ingero shingiro',
    baseUnitHint: 'Icyo ubarira ububiko — BOTTLE, EA, KG.',
    descriptionLabel: 'Ibisobanuro',
    sellingPrice: 'Igiciro cyo kugurisha',
    costPrice: 'Igiciro cyo kugura',
    costPriceHint: 'Icyo wishyura. Gikenewe mu kubara inyungu.',
    taxClassLabel: 'Umusoro',
    taxStandard: 'Usanzwe',
    taxZero: 'Wa zeru',
    taxExempt: 'Usonewe',
    returnableLabel: 'Ingwate kuri {unit}',
    returnableHint: 'Siga ubusa niba ingero itagarurwa.',
    addPack: 'Ongeraho ipaki',
    packUnit: 'Ingero',
    packQuantity: 'Irimo',
    packPrice: 'Igiciro cy’ipaki',
    packCost: 'Ikiguzi cy’ipaki',
    packBarcode: 'Barcode',
    packHint: 'Agasanduku ka 24 kagurishwa nk’ingero imwe, gakuremo 24 mu bubiko.',
    removePack: 'Kuraho ipaki',
    close: 'Funga',
    editTitle: 'Hindura igicuruzwa',
    editLabel: 'Hindura {name}',
    saveChanges: 'Bika impinduka',
    baseUnitLocked: 'Ntibishoboka guhindura: ububiko bubarwa muri iyi ngero.',
    rowActions: 'Ibikorwa',
    archive: 'Kuvana mu bicuruzwa',
    archiveLabel: 'Kuvana {name} mu bicuruzwa',
    restore: 'Kugarura mu bicuruzwa',
    restoreLabel: 'Kugarura {name} mu bicuruzwa',
    packagingInvalid: 'Buri paki isaba ingero, umubare irimo, n’igiciro.',
    quartersOn: 'Ibice bine byemewe',
    quartersOff: 'Nta bice bine',
    perPack: '{unit} ya {count}',
...
const fr: Dictionary = {
  ...
  products: {
    ...
    adding: 'Ajout…',
    basics: 'Général',
    pricing: 'Prix et taxe',
    packagingSection: 'Conditionnements',
    baseUnit: 'Unité de base',
    baseUnitHint: 'Ce que vous comptez en stock — BOTTLE, EA, KG.',
    descriptionLabel: 'Description',
    sellingPrice: 'Prix de vente',
    costPrice: 'Prix de revient',
    costPriceHint: 'Ce que vous payez. Nécessaire pour la marge.',
    taxClassLabel: 'Taxe',
    taxStandard: 'Standard',
    taxZero: 'Taux zéro',
    taxExempt: 'Exonéré',
    returnableLabel: 'Consigne par {unit}',
    returnableHint: 'Laissez vide si l’unité n’est pas retournée.',
    addPack: 'Ajouter un conditionnement',
    packUnit: 'Unité',
    packQuantity: 'Contient',
    packPrice: 'Prix du lot',
    packCost: 'Coût du lot',
    packBarcode: 'Code-barres',
    packHint: 'Une caisse de 24 se vend comme une unité et retire 24 du stock.',
    removePack: 'Supprimer',
    close: 'Fermer',
    editTitle: 'Modifier le produit',
    editLabel: 'Modifier {name}',
    saveChanges: 'Enregistrer',
    baseUnitLocked: 'Non modifiable : le stock est compté dans cette unité.',
    rowActions: 'Actions',
    archive: 'Retirer de la vente',
    archiveLabel: 'Retirer {name} de la vente',
    restore: 'Remettre en vente',
    restoreLabel: 'Remettre {name} en vente',
    packagingInvalid: 'Chaque conditionnement exige une unité, une quantité et un prix.',
    quartersOn: 'Quarts autorisés',
    quartersOff: 'Pas de quarts',
    perPack: '{unit} de {count}',
